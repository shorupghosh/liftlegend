...
type DemoDataContextValue = {
  ...
  metrics: DemoMetrics;
  resetDemoData: () => void;
  addMember: (payload: Pick<Member, 'full_name' | 'email' | 'phone' | 'member_number' | 'plan_id' | 'join_date' | 'expiry_date'>) => Member;
...
export function DemoDataProvider({ children }: { children: React.ReactNode }) {
  ...
  const addMember = (payload: Pick<Member, 'full_name' | 'email' | 'phone' | 'member_number' | 'plan_id' | 'join_date' | 'expiry_date'>) => {
    ...
    setState((current) => {
      ...
      const member: Member = {
        ...
        expiry_date: payload.expiry_date || (plan
